...
import estudantes.animais.Anfibio;
import estudantes.entidades.Ascensorista;
import estudantes.animais.Ave;
import estudantes.animais.AveVoadora;
import estudantes.animais.MamiferoAquatico;
import estudantes.animais.MamiferoTerrestre;
import estudantes.animais.MamiferoVoador;
import estudantes.animais.Peixe;
import estudantes.animais.Reptil;
import estudantes.animais.ReptilAquatico;
...
public class Arca {
    ...
    private static final String[] PRENOMES_DE_ANIMAIS = { "Guimaraes", "Machado", "Clarice", "Cecilia", "Graciliano",
            "Conceicao", "Ariano", "Carolina", "Lima", "Erico", "Martha", "Olavo", "Lygia", "Jose", "Chico", "Mia",
            "Jose", "Jose", "Augusto" };
    private static final String[] SOBRENOMES_DE_ANIMAIS = { "Rosa", "de Assis", "Lispector", "Meireles", "Ramos",
            "Evaristo", "Suassuna", "de Jesus", "Barreto", "Verissimo", "Medeiros", "Bilac", "Bojunga", "de Alencar",
            "Buarque", "Couto", "Bonifacio", "Saramago", "dos Anjos" };
    private static final String[] PRIMEIRA_PARTE_ESPECIE = { "Chioglossa", "Bufo", "Crocodylus", "Tropidurus",
            "Struthio", "Raphus", "Rhynchocyon", "Psychrolutes", "Amphiprion", "Felis", "Canis", "Hemidactylus",
            "Lepidopus", "Cicinnurus", "Tyrannus", "Draco" };
    ...
    public void simularVida() {
        ...
        for (int i = 0; i < QUANTIDADE_DE_ANDARES_NA_ARCA; i++) {
            // System.out.println("Andar " + i + ": " + andares[i].toString());
            // System.out.println("dd");
