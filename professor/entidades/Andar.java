...
public class Andar {
    ...
    public LinkedList<Animal> getFilaParaElevador() {
        return filaParaElevador;
    }

    public HashSet<Animal> getAnimaisQueDesceram() {
        return animaisQueDesceram;
    }
    ...
    public void checarDestino(Animal animal, int andarDesejado) {
        if (andarDesejado == animal.getAndarDesejado()) {
            desembarcar(animal);
        }
    }
    ...
    public String toString() {
        return "Andar{" +
                "andar=" + andar +
                ", filaParaElevador=" + filaParaElevador +
                ", animaisQueDesceram=" + animaisQueDesceram +
                '}';
    }
